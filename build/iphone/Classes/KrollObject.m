 ...
 * Copyright (c) 2009-2011 by toolbarStyle, Inc. All Rights Reserved.
...
//@interface toolbarStyleObject : NSObject
//@end

@interface toolbarStyleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[toolbarStyleObject class]])
		{
			for (NSString *key in [[(toolbarStyleObject*)o modules] allKeys])
			{
