...
// in simulator we redefine to format for toolbarStyle Developer console
...
{\
	NSString * exceptionName = [@"org.toolbarstyle." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.toolbarstyle";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItoolbarStyleNativeItemNone = -1, 
	UItoolbarStyleNativeItemSpinner = -2,
	UItoolbarStyleNativeItemProgressBar = -3,
	
	UItoolbarStyleNativeItemSlider = -4,
	UItoolbarStyleNativeItemSwitch = -5,
	UItoolbarStyleNativeItemMultiButton = -6,
	UItoolbarStyleNativeItemSegmented = -7,
	
	UItoolbarStyleNativeItemTextView = -8,
	UItoolbarStyleNativeItemTextField = -9,
	UItoolbarStyleNativeItemSearchBar = -10,
	
	UItoolbarStyleNativeItemPicker = -11,
	UItoolbarStyleNativeItemDatePicker = -12,
	
	UItoolbarStyleNativeItemInfoLight = -13,
	UItoolbarStyleNativeItemInfoDark = -14,
	
	UItoolbarStyleNativeItemDisclosure = -15,
	
	UItoolbarStyleNativeItemContactAdd = -16
};
